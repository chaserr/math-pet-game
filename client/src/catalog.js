...
const GENERATED_GROWTH_RESOURCE_DEFS = {
  ...
  boo_star: {
    ...
    food: '星之尘',
    theme: 'star',
    resource_version: 'boo-star-growth-v1-2026-05-26',
    style_reference: 'cute polished 3D mobile game pet, children arithmetic companion, star ghost king PDF reference, clean centered full-body asset',
    source_reference: '/Users/tongxing/Person/教材/嘘嘘鬼王.pdf',
    display_names: ['星芽小嘘', '星游嘘', '星盾鬼', '星辉鬼王'],
    feature: '星辉王冠、星翼披风和蓝金符文星光',
  },
  dog: {
    pet_id: 'dog_001',
    pet_name: '小狗',
  ...
  nb0: {
    ...
    food: '能量块',
    theme: 'digit0',
    resource_version: 'nb0-growth-v1-2026-05-26',
    style_reference: 'uses existing /numberblocks/0.png as primary visual source; children arithmetic companion pet',
    source_reference: '/numberblocks/0.png',
    display_names: ['小零泡', '弯弯零', '圆盾零', '零环灵王'],
    feature: '圆环嘴形和柔软弧线',
  },
  nb1: {
    pet_id: 'nb1_001',
    ...
    food: '能量块',
    theme: 'digit1',
    resource_version: 'nb1-growth-v1-2026-05-26',
    style_reference: 'uses existing /numberblocks/1.png as primary visual source; children arithmetic companion pet',
    source_reference: '/numberblocks/1.png',
    display_names: ['独眼一仔', '红块一', '先锋一', '赤冠一将'],
    feature: '红色方块身体和独眼表情',
  },
  nb2: {
    pet_id: 'nb2_001',
    ...
    food: '能量块',
    theme: 'digit2',
    resource_version: 'nb2-growth-v1-2026-05-26',
    style_reference: 'uses existing /numberblocks/2.png as primary visual source; children arithmetic companion pet',
    source_reference: '/numberblocks/2.png',
    display_names: ['眼镜二宝', '探路二', '智盾二', '智算二星'],
    feature: '紫色眼镜和橙色身体',
  },
  nb3: {
    pet_id: 'nb3_001',
    ...
    food: '能量块',
    theme: 'digit3',
    resource_version: 'nb3-growth-v1-2026-05-26',
    style_reference: 'uses existing /numberblocks/3.png as primary visual source; children arithmetic companion pet',
    source_reference: '/numberblocks/3.png',
    display_names: ['按钮三宝', '冲冲三', '勇盾三', '三冠勇将'],
    feature: '黄色长身和红色按钮',
  },
  nb4: {
    pet_id: 'nb4_001',
    ...
    food: '能量块',
    theme: 'digit4',
    resource_version: 'nb4-growth-v1-2026-05-26',
    style_reference: 'uses existing /numberblocks/4.png as primary visual source; children arithmetic companion pet',
    source_reference: '/numberblocks/4.png',
    display_names: ['绿方四', '跳跳四', '方盾四', '绿甲四王'],
    feature: '绿色方块身体和双眼方脸',
  },
  nb5: {
    pet_id: 'nb5_001',
    ...
    food: '能量块',
    theme: 'digit5',
    resource_version: 'nb5-growth-v1-2026-05-26',
    style_reference: 'uses existing /numberblocks/5.png as primary visual source; children arithmetic companion pet',
    source_reference: '/numberblocks/5.png',
    display_names: ['星星五', '旋风五', '星盾五', '五芒星卫'],
    feature: '青色长身和星形法杖',
  },
  nb6: {
    pet_id: 'nb6_001',
    ...
    food: '能量块',
    theme: 'digit6',
    resource_version: 'nb6-growth-v1-2026-05-26',
    style_reference: 'uses existing /numberblocks/6.png as primary visual source; children arithmetic companion pet',
    source_reference: '/numberblocks/6.png',
    display_names: ['紫点六', '抱抱六', '重盾六', '紫曜六王'],
    feature: '紫色六点身体和多手造型',
  },
  nb7: {
    pet_id: 'nb7_001',
    ...
    food: '能量块',
    theme: 'digit7',
    resource_version: 'nb7-growth-v1-2026-05-26',
    style_reference: 'uses existing /numberblocks/7.png as primary visual source; children arithmetic companion pet',
    source_reference: '/numberblocks/7.png',
    display_names: ['彩条七', '伸伸七', '彩盾七', '虹桥七灵'],
    feature: '彩虹长条身体和头顶数字',
  },
  nb8: {
    pet_id: 'nb8_001',
    ...
    food: '能量块',
    theme: 'digit8',
    resource_version: 'nb8-growth-v1-2026-05-26',
    style_reference: 'uses existing /numberblocks/8.png as primary visual source; children arithmetic companion pet',
    source_reference: '/numberblocks/8.png',
    display_names: ['粉格八', '摆摆八', '格盾八', '粉晶八后'],
    feature: '粉色八格身体和灵活动作',
  },
  nb9: {
    pet_id: 'nb9_001',
    ...
    food: '能量块',
    theme: 'digit9',
    resource_version: 'nb9-growth-v1-2026-05-26',
    style_reference: 'uses existing /numberblocks/9.png as primary visual source; children arithmetic companion pet',
    source_reference: '/numberblocks/9.png',
    display_names: ['灰块九', '歪歪九', '钢盾九', '钢冠九王'],
    feature: '灰色九块身体和歪头表情',
  },
};
...
function buildGeneratedGrowthResource(runtimePetId, def) {
  return {
    ...
    food: def.food,
    resource_version: def.resource_version || `${runtimePetId}-growth-v1-2026-05-23`,
    style_reference: def.style_reference || 'cute polished 3D mobile game pet, children arithmetic companion, clean centered full-body asset',
    ...(def.source_reference ? { source_reference: def.source_reference } : {}),
